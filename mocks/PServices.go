...
// PServices is an autogenerated mock type for the PServices type
type PServices struct {
	mock.Mock
}

// AddProduct provides a mock function with given fields: newProduct
func (_m *PServices) AddProduct(newProduct products.Product) error {
...
func (_m *PServices) CountAllProducts(term string) (int64, error) {
	ret := _m.Called(term)
...
func (_m *PServices) CountProductsByUserID(userID uint, term string) (int64, error) {
...
func (_m *PServices) DeleteProduct(id uint) error {
	ret := _m.Called(id)
...
func (_m *PServices) GetAllProducts(term string, limit int, offset int) ([]products.Product, error) {
...
func (_m *PServices) GetProductByID(id uint) (products.Product, users.User, error) {
	ret := _m.Called(id)
...
func (_m *PServices) GetProductsByUserID(user_id uint, term string, limit int, offset int) ([]products.Product, error) {
...
func (_m *PServices) UpdateProductByID(id uint, updatedProduct products.Product) error {
...
// NewPServices creates a new instance of PServices. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPServices(t interface {
	mock.TestingT
	Cleanup(func())
}) *PServices {
	mock := &PServices{}
