...
func (dth *DetailTransactionHandler) GetAllCart(c echo.Context) error {
	...
	return c.JSON(200, helper.ResponseFormat(200, "Shopping Cart datas successfully retreived!", ToCartResponse(transaction, cart)))
}
...
func (dth *DetailTransactionHandler) AddToCart(c echo.Context) error {
	...
	return c.JSON(201, helper.ResponseFormat(201, "Product successfully added to Shopping Cart!", nil))
}
...
func (dth *DetailTransactionHandler) UpdateCart(c echo.Context) error {
	...
	return c.JSON(200, helper.ResponseFormat(200, "Shopping Cart item quantity successfully updated!", nil))
}
